@if (is_admin())
  <img class="img-preview" src="{{ get_stylesheet_directory_uri() }}/Blocks/PAFeaturePost/preview.png" alt="{{ __('Illustrative image of the front end of the block.', 'downloads') }}"/>
@elseif(!empty($id))
  <div class="col-lg-8">
